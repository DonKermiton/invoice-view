...
export const loggedUserReducers = createReducer(
  CreateInitialState({}),
  on(RegisterActions.start, (_state, { props }) => DefaultHttpStart(_state)),
  ...
  on(AutoLoginActions.start, (_state, { props }) => DefaultHttpStart(_state)),
  ...
  on(ManualLoginActions.start, (_state, { props }) => DefaultHttpStart(_state)),
